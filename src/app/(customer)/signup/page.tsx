      ...
      >
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="fullName" type="text" placeholder="Abhishek Sharma" {...register('fullName')} className="bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus-visible:ring-[#FF5C00] pl-10" />
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2">
                ...
                <Input id="phone" type="tel" placeholder="9876543210" maxLength={10} {...register('phone')} className="bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus-visible:ring-[#FF5C00]" />
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="you@example.com" {...register('email')} className="bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus-visible:ring-[#FF5C00] pl-10" />
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="password" type="password" placeholder="Min. 6 characters" {...register('password')} className="bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus-visible:ring-[#FF5C00] pl-10" />
              </div>
            ...
            {/* Address */}
            <div className="space-y-1.5">
              <Label htmlFor="address" className="text-gray-700">Home Address</Label>
              <div className="relative">
                <MapPin className="absolute left-3 top-3 w-4 h-4 text-gray-400" />
                <Textarea id="address" placeholder="Flat/House No., Building, Street, Area, Nagpur" {...register('address')} className="bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus-visible:ring-[#FF5C00] pl-10 min-h-[70px]" />
              </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-white px-3 text-gray-500">Or</span></div>
          </div>

          {/* Google */}
          <Button type="button" variant="outline" onClick={handleGoogleSignIn} disabled={googleLoading} className="w-full border-gray-300 bg-white hover:bg-gray-50 text-gray-900 font-medium">
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <a href="/login" className="text-[#FF5C00] hover:text-[#e05200] font-medium transition-colors">Sign In</a>
          </p>
        </div>
      </motion.div>
